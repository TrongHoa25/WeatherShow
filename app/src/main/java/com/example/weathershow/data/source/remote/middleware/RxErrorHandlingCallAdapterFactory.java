package com.example.weathershow.data.source.remote.middleware;

import android.text.TextUtils;
import android.util.Log;

import com.example.weathershow.data.source.remote.error.BaseException;
import com.example.weathershow.data.source.remote.response.ErrorResponse;
...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    class RxCallAdapterWrapper<R> implements CallAdapter<R, Object> {
        ...
        private Throwable convertToBaseException(Throwable throwable) {
